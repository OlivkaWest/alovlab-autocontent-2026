...
# 11 Универсальный промпт выбора (полный)
P.append(page("Промпт выбора",11,
  head("Главный промпт","Пусть ИИ сам разложит задачу на стек",
    "Когда задача большая и непонятно, с чего начать, отдай выбор самому ИИ.")
  + prompt(
    "Вот моя задача: [ВСТАВЬ ЗАДАЧУ].\n"
    "Разложи её на этапы. Для каждого этапа укажи:\n"
    "1. что именно нужно сделать;\n"
    "2. какой тип работы это: текст / код / поиск /\n"
    "   изображение / голос / анализ файлов;\n"
    "3. какой инструмент лучше подходит (Claude / ChatGPT / оба);\n"
    "4. почему именно этот инструмент;\n"
    "5. где передать результат из одного инструмента в другой.\n"
    "Не выбирай один сервис из лояльности. Оптимизируй стек под результат.\n"
    "Верни таблицей, затем итоговый стек и короткую рекомендацию.",
    "готовый план: какой этап каким инструментом делать и куда передавать результат.")
))

# 12 Твой стек на каждый день
P.append(page("Твой стек",12,
  head("Система","Твой стек на каждый день",
    "Не одна модель на всё, а набор под задачи. Вот рабочий минимум.")
  + '<table class="pt"><tr><th>Инструмент</th><th>За что отвечает</th><th>Когда брать</th></tr>'
    '<tr><td class="tool">Claude</td><td>текст, документы, код, анализ</td><td>глубина и точность</td></tr>'
    '<tr><td class="tool">ChatGPT</td><td>идеи, картинки, голос, быстрые форматы</td><td>старт и широта</td></tr>'
    '<tr><td class="tool">Perplexity</td><td>поиск с источниками, проверка фактов</td><td>актуальность</td></tr>'
    '<tr><td class="tool">Higgsfield</td><td>визуалы, креативные референсы</td><td>идеи и стиль</td></tr>'
    '<tr><td class="tool">Seedance</td><td>видео из кадров и сцен</td><td>видео-контент</td></tr>'
    '<tr><td class="tool">ElevenLabs</td><td>озвучка, голос, подкасты</td><td>звук</td></tr>'
    '</table>'
  + '<p class="note">Инструмент не важнее задачи. Система важнее инструмента. Стек проверяй под результат, не по привычке.</p>'
))

# 13 Честная разбивка + чек
P.append(page("Сильные стороны",13,

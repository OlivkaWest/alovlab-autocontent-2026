...
| 31–34 | avatar | Полный список из десяти фраз и промпт — в комментариях. Забирай, сохрани. | лицо + логотип A | 10 фраз ↓ **в комментариях** | ON |
...
>
> Полный список из десяти фраз и промпт — в комментариях. Забирай, сохрани.
...
Ключевые: `5 фраз · сохрани` → `1…2…3…4…5` → `первое слово работает` → `промпт → живой текст` → `до / после` → `10 фраз ↓ в комментариях`.
...
>
> Полный стоп-лист из 10 фраз и промпт — в комментариях под этим постом. Забирай, сохрани.

---

## 9. Финальный CTA

Голос: «Полный список из десяти фраз и промпт — в комментариях. Забирай, сохрани.»
...
Says: «Полный список из десяти фраз и промпт — в комментариях. Забирай, сохрани.»
Close-up + AlovLab logo (orange A). On-screen: «10 фраз ↓ в комментариях».
